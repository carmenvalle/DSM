...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: diagGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        try
        {
                CreateDB.Create ("diagGenNHibernate", "nhibernateUser", "nhibernatePass");
